...
public class WebIATWS extends WebSocketListener {
    ...
    private static final String apiKey = "fc74565cc61b3981dd9f3e094f01b8ef"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String apiSecret = "58a6987ab480fffe6861df01f7194b80"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String appid = "5d5b6c2f"; //在控制台-我的应用获取
